...
### ダウンロードとインストール
Omitは個人開発者によるオープンソースプロジェクトであり、Appleによる署名が行われていないため、初回起動時にセキュリティ警告が表示される場合があります。

1.  [**最新バージョンをダウンロード (Omit.zip)**](你的Releases下载链接)
2.  アプリを **「アプリケーション」** フォルダにドラッグします。
3.  アイコンを **右クリック** し、 **「開く」** を選択します。
4.  表示されるダイアログで **「開く」** をクリックしてください。
